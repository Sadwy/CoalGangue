...
# def coalgangue_classes():
#     """CoalGangue class names for external use."""
#     return ['coal', 'gangue']

# def coalgangue_palette():
#     """CoalGangue palette for external use."""
#     return [[255, 255, 0], [0, 255, 255]]

def coalgangue_classes():
    """CoalGangue class names for external use."""
    return ['background', 'coal', 'gangue']

def coalgangue_palette():
    """CoalGangue palette for external use."""
    return [[120, 120, 120], [255, 255, 0], [0, 255, 255]]
...
dataset_aliases = {
    'coalgangue': ['coalgangue', 'coal_gangue'],
